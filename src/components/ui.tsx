...
export function Tabs({ items, active, onChange, className }: TabsProps) {
  return (
    <div className={cn('flex gap-1 border-b border-ink-700', className)} role="tablist" aria-label="视图切换">
      {items.map((item, index) => (
        <button
          ...
          className={cn(
            'relative px-3 py-2 text-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-emerald-400/40',
            active === item.key
              ? 'text-emerald-300'
